...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table(u'Bar_note', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'Bar', ['Note'])


        # Changing field 'Session.start_session'
        db.alter_column(u'Bar_session', 'start_session', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'Bar_note')


        # Changing field 'Session.start_session'
        db.alter_column(u'Bar_session', 'start_session', self.gf('django.db.models.fields.DateTimeField')())
